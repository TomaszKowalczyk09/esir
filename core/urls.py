...
path(
    ...
    path("komisje/<int:komisja_id>/sesje/<int:sesja_id>/glosowania/", views.komisja_sesja_glosowania, name="komisja_sesja_glosowania"),
    path("komisje/glosowanie/<int:glosowanie_id>/toggle/", views.komisja_toggle_glosowanie, name="komisja_toggle_glosowanie"),
    path("komisje/glosowanie/<int:glosowanie_id>/glosuj/", views.komisja_oddaj_glos, name="komisja_oddaj_glos"),
    path("api/komisja/wyniki/<int:glosowanie_id>/", views.api_komisja_wyniki, name="api_komisja_wyniki"),
    path("api/komisja/glosy-jawne/<int:glosowanie_id>/", views.api_komisja_lista_glosow_jawne, name="api_komisja_lista_glosow_jawne"),
    path("komisje/<int:komisja_id>/sesje/<int:sesja_id>/ekran/", views.komisja_sesja_ekran, name="komisja_sesja_ekran"),
    path("api/komisja/sesja/<int:sesja_id>/aktywny-punkt/", views.api_komisja_aktywny_punkt, name="api_komisja_aktywny_punkt"),
